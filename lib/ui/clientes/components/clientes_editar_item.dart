...
import 'package:repsys/ui/catalogo/components/deletar_item.dart';
...
class ClientesEditarItem extends StatefulWidget {
  const ClientesEditarItem({super.key, required this.item});
  final CatalogoModel item;

  @override
  State<ClientesEditarItem> createState() => _ClientesEditarItemState();
}

class _ClientesEditarItemState extends State<ClientesEditarItem> {
  ...
  void initState() {
    ...
    _imeiController.text = widget.item.imei ?? '';
    _valorCompraController.text =
        currencyFormat.format(widget.item.valorCompra);
    _valorVendaController.text = currencyFormat.format(widget.item.valorVenda);
  }
